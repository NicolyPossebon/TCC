<?php
	...
	//recendo dados do formulário de login e tratando com  mysqli_real_escape_string, para evitar injeções.
	...
	//função mysqli_num_rows atribui a variável $row o numero de linhas, no caso usuário, 
