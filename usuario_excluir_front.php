					...
					<form action="usuario_excluir_back.php" method="post">
						...
						<div class="row justify-content-center"> 
							<div class="col-sm-11 col-md-10 col-lg-9 mb-3 text-center"> 
								<label for="#" class="texto-corpo">Para excluir sua conta, insira a sua senha.</label>
								<input type="password" class="form-control" name="senha_usuario" 
								required>
								<p class="text-justify mt-2 texto-corpo">Tem certeza que deseja excluir a sua conta <i class="far fa-sad-tear"></i>? Depois de efetuar a exclusão você perderá acesso a sua conta e as mensagens trocadas com a Coordenação de Ações Inclusiva.</p>
						...
						<div class="row justify-content-center">
							<div class="col-sm-11 col-md-10 col-lg-9 text-center">
								<button type="submit" class="btn cinza text-white texto-corpo texto-buttons"  style="background-color: #3CB371;" onclick="return validar()">
									EXCLUIR CONTA
								</button> 
							</div>
						</div>
