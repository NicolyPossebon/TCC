					...
					<form name="cadastro_form" action="usuario_cadastro_back.php" method="post">
						...
						<div class="row justify-content-center"> 
							<div class="col-sm-11 col-md-10 col-lg-9 mb-3"> 
								...
								<input type="text" class="form-control" name="nome_usuario"  placeholder="" required>
							</div>
						</div>
						...
						<div class="row justify-content-center">
							<div class="col-sm-11 col-md-10 col-lg-9 mb-3 ">
								...
								<input type="Email" class="form-control" name="email_usuario" placeholder="">
							</div>
						</div>
						...
						<!-- Login -->
						<div class="row justify-content-center">
					    	<div class="col-sm-11 col-md-10 col-lg-9 text-center mb-4">
					    	<hr>
